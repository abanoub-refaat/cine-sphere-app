...
const FreeTrial = () => {
  return (
    <div className="flex bg-[url(/Images/FreeTrial.png)] bg-cover bg-center w-full px-4 py-12 sm:py-16 md:py-20 justify-center">
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20 max-w-6xl w-full">
